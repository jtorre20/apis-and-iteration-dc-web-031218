...
def get_character_movies_from_api(character)
  ...
  character_variable = character_hash['results']
  target_character = character_variable.find {|info_hash| info_hash["name"].downcase.include?(character)}
  films_array = target_character["films"]
  #binding.pry
  ...
  # return value of this method should be collection of info about each film.
      #  i.e. an array of hashes in which each hash reps a given 
